...
```{r fcs_province_plot, echo = FALSE, fig.align = "center", fig.width = 8}
endline_fcs_province_table |>
  ...
  labs(
    ...
    subtitle = "Proportion of households in Zambézia, Nampula, and overall by food insecurity category based on food consumption score",
    x = "", y = "%"
  ) +
...
endline_fcs_strata_table |>
  ...
  labs(
    title = "Food insecurity status based on food consumption score",
    subtitle = "Proportion of households in districts of Zambézia and Nampula\nby food insecurity category based on food consumption score",
    x = "", y = "%"
  ) +
...
```{r rcsi_province_plot, echo = FALSE, fig.align = "center", fig.width = 8}
...
endline_rcsi_strata_table |>
  ...
  labs(
    title = "Food insecurity status based on reduced coping strategies index",
    subtitle = "Proportion of households in districts of Zambézia and Nampula by food insecurity category based on reduced coping strategies index",
    x = "", y = "%"
  ) +
  facet_wrap(~province, scales = "free_x") +
  theme_mozambique
...
```{r lcsi_province_plot, echo = FALSE, fig.align = "center", fig.width = 8}
...
endline_lcsi_strata_table |>
  ...
  labs(
    title = "Food insecurity status based on livelihoods coping strategies index",
    subtitle = "Proportion of households in districts of Zambézia and Nampula by food insecurity category based on livelihoods coping strategies index",
    x = "", y = "%"
  ) +
  facet_wrap(~province, scales = "free_x") +
  theme_mozambique
