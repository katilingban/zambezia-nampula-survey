...
opv_province_overall <- rbind(
  ...
  baseline_child_immunisation_set2_province_table,
  baseline_child_immunisation_set3_province_table
) |>
  subset(
...
opv_strata <- rbind(
  ...
  baseline_child_immunisation_set2_strata_table,
  baseline_child_immunisation_set3_strata_table
) |>
  subset(
...
opv_study_group <- rbind(
  ...
  baseline_child_immunisation_set2_study_group_table,
  baseline_child_immunisation_set3_study_group_table
) |>
  subset(
