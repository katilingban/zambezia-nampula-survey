...
```{r diarrhoea_treatment, echo = FALSE, eval = FALSE}
baseline_child_ill_treatment_province_table_report |>
  subset(
    select = c(
      -indicator_label, -indicator_set, -indicator, 
      -study_round, -study_group
...
```{r diarrhoea_treatment_study_group, echo = FALSE, eval = FALSE}
baseline_child_ill_treatment_study_group_table_report |>
  subset(
    select = c(
      -indicator_label, -indicator_set, -indicator, 
      -study_round, -strata
