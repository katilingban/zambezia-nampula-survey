...
## Child anthropometry - 6 to 59 months
...
overall_results_all |>
  subset(
    indicator_set_code == "child_anthro_subset" & study_round == "Baseline" &
      strata %in% c("Zambézia", "Nampula", "Overall") & 
      indicator_variable != "severe_wasting_by_oedema" &
      stringr::str_detect(
        string = indicator_variable, pattern = "global", negate = TRUE
...
child_stunting_province_overall <- baseline_child_anthro_subset_province_table |>
  subset(
    indicator_variable %in% c(
      "hfaz", "global_stunting", "moderate_stunting", "severe_stunting"
    ),
...
child_stunting_strata <- baseline_child_anthro_subset_strata_table |>
  subset(
    indicator_variable %in% c(
      "hfaz", "global_stunting", "moderate_stunting", "severe_stunting"
    ) &
...
child_stunting_study_group <- baseline_child_anthro_subset_study_group_table |>
  subset(
    indicator_variable %in% c(
      "hfaz", "global_stunting", "moderate_stunting", "severe_stunting"
    ) &
...
child_underweight_province_overall <- baseline_child_anthro_subset_province_table |>
  subset(
    indicator_variable %in% c(
      "wfaz", "global_underweight", "moderate_underweight", "severe_underweight"
    ),
...
child_underweight_strata <- baseline_child_anthro_subset_strata_table |>
  subset(
    indicator_variable %in% c(
      "wfaz", "global_underweight", "moderate_underweight", "severe_underweight"
    ) &
...
child_underweight_study_group <- baseline_child_anthro_subset_study_group_table |>
  subset(
    indicator_variable %in% c(
      "wfaz", "global_underweight", "moderate_underweight", "severe_underweight"
    ) &
...
child_wasting_province_overall <- baseline_child_anthro_subset_province_table |>
  subset(
    indicator_label %in% c(
      "Weight-for-height z-score", "Child wasting by weight-for-height z-score"
    ),
...
child_wasting_strata <- baseline_child_anthro_subset_strata_table |>
  subset(
    indicator_label %in% c(
      "Weight-for-height z-score", "Child wasting by weight-for-height z-score"
    ) &
...
child_wasting_study_group <- baseline_child_anthro_subset_study_group_table |>
  subset(
    indicator_label %in% c(
      "Weight-for-height z-score", "Child wasting by weight-for-height z-score"
    ) &
...
child_oedema_province_overall <- baseline_child_anthro_subset_province_table |>
  subset(
    indicator_label == "Child wasting by oedema",
    select = c(indicator_category, strata, estimate, lcl, ucl)
  ) |>
...
child_oedema_strata <- baseline_child_anthro_subset_strata_table |>
  subset(
    indicator_label == "Child wasting by oedema" &
      strata != "Overall",
    select = c(indicator_category, strata, estimate, lcl, ucl)
...
child_oedema_study_group <- baseline_child_anthro_subset_study_group_table |>
  subset(
    indicator_label == "Child wasting by oedema" &
      study_group != "Overall",
    select = c(indicator_category, study_group, estimate, lcl, ucl)
...
water_subset_province_overall <- baseline_wash_subset_province_table |>
  subset(
...
water_subset_strata <- baseline_wash_subset_strata_table |>
  subset(
...
water_subset_study_group <- baseline_wash_subset_study_group_table |>
  subset(
...
sanitation_subset_province_overall <- baseline_wash_subset_province_table |>
  subset(
...
sanitation_subset_strata <- baseline_wash_subset_strata_table |>
  subset(
...
sanitation_subset_study_group <- baseline_wash_subset_study_group_table |>
  subset(
...
hygiene_subset_province_overall <- baseline_wash_province_table |>
  subset(
...
hygiene_subset_strata <- baseline_wash_strata_table |>
  subset(
...
hygiene_subset_study_group <- baseline_wash_study_group_table |>
  subset(
...
baseline_observation_province_table_report |>
  subset(
    select = c(
      -indicator_label, -indicator_set, -indicator, 
      -study_round, -study_group
...
baseline_observation_study_group_table_report |>
  subset(
    select = c(
      -indicator_label, -indicator_set, -indicator, 
      -study_round, -strata
...
```{r pica, echo = FALSE}
baseline_pica_province_table_report |>
  subset(
...
baseline_pica_study_group_table_report |>
  subset(
    #indicator_label %in% c("Pica frequency", "Cleaning of child who eats dirt"),
    select = c(
      -indicator_label, -indicator_set, -indicator, 
